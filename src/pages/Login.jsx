    ...
    <div className="flex h-screen w-screen overflow-hidden bg-[#080f0a] font-sans">
      ...
      <div className="relative hidden md:flex w-[48%] overflow-hidden">
        ...
        <div className="absolute top-7 left-7 flex items-center gap-2 bg-black/40 backdrop-blur-md border border-green-400/25 rounded-full px-4 py-2">
          ...
          <span className="text-green-100 text-sm font-semibold tracking-wide">NexAuth</span>
        </div>
      </div>
      ...
      <div className="relative flex flex-1 items-center justify-center px-8">
        ...
        <div className="relative z-10 w-full max-w-sm">
          ...
          <h1 className="text-4xl font-bold text-green-50 tracking-tight mb-1">Sign in</h1>
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-xs text-[#4b5e52] whitespace-nowrap">or sign in with email</span>
            <div className="flex-1 h-px bg-green-400/15" />
          </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-xs text-[#6b7c6e]">Remember me</span>
            </label>
            <a href="#" className="text-xs text-green-400 font-medium hover:underline">
              Forgot password?
            </a>
          </div>
          ...
          <p className="text-center text-xs text-[#4b5e52]">
            ...
            <a href="#" className="text-green-400 font-semibold hover:underline">Sign up</a>
          </p>
