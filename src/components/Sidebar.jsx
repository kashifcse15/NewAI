...
import {LuImage,LuCoins,LuMoon,LuUser,LuLogOut} from "react-icons/lu"

const Sidebar = () => {
  const { user, chats, selectedChat, theme, setTheme, navigate } = useAppContext();
  const [search, setSearch] = useState('');
  return (
<div className='flex flex-col h-[95vh] w-72 m-4 p-5 bg-white dark:bg-[#111111] border border-green-100 rounded-3xl shadow-xl shadow-green-100/40'>
